...
class SkillsToAchivedTumbling : AppCompatActivity() {

    var list: MutableList<Skill> = mStuntsCultureItems!!.stuntsCultureItems[0].skills
    var displayList: MutableList<Skill> = LoadingItems.mStuntsCultureItemsSearch!!.stuntsCultureItems[0].skills
