...
import fr.mathieugalidie.myapplication.LoadingItems.LoadingItems.mYoutubeListStunts
...
class YoutubeListFragment2 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView_general.apply {
            ...
            adapter = YoutubeAdapter(mYoutubeListStunts) { youtubeItems->youtubeItemOnClickListener(youtubeItems)}
        }
    }
