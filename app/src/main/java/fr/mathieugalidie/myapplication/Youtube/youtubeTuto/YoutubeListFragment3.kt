...
import fr.mathieugalidie.myapplication.LoadingItems.LoadingItems.mYoutubeListRenfo
...
class YoutubeListFragment3 : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerView_general.apply {
            ...
            adapter = YoutubeAdapter(mYoutubeListRenfo) { youtubeItems->youtubeItemOnClickListener(youtubeItems)}
        }
    }
